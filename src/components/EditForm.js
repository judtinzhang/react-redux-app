    ...
    <>
      ...
      <div>
        <div>
          ...
          Image:
          <br />
          <img src={image} alt="Not able to Render" />
          <br />
          Description:
          {desc}
        </div>
        <button type="submit" className="btn btn-primary" onClick={() => setIsEdit(true)}>Edit</button>
      </div>
      )}
      {isEdit && (
        <div>
          ...
          <button type="submit" className="btn btn-primary" onClick={() => setIsEdit(false)}>Cancel</button>
          <button
            type="submit"
            className="btn btn-primary"
            onClick={() => {
